...
import 'package:newkhabar/components/appbar.dart';
...
Future<List> fetchbusiness() async {
  final response = await http.get(
    Uri.parse(
        'https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=100&apiKey=' +
            Keys.key +
            '&q=' +
